    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            double length = 0, width = 0,
                   areaForFirstRectangle = Area(length, width), 
                   areaForSecondRectangle = Area(length, width), 
                   area = areaForFirstRectangle + areaForSecondRectangle, 
                   gallons = area / squaredFeet;

            Console.WriteLine($"Total area of the two rectangles = {area} squared feet.");
