namespace Blood_Alcohol_Calculator_v2
{
    internal class Program
    {
        ...
        {
            double weight = ConvertInputToDouble("What is your weight? ") * 2.205;
            double alcoholVolume = ConvertInputToDouble("What volume of alcohol did you take? ") / 29.6;
